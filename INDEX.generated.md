...
23 deep-read record(s). Regenerate: `python tools/kb.py index`.
...
- **`laurinavichyute2022-share-the-code`** (2022, Journal of Memory and Language 125:104332) — Share the code, not just the data: A case study of the reproducibility of articles published in the Journal of Memory and Language under the open data policy
  ...
  - cito:agreesWith → `hardwicke2018-cognition-open-data`; cito:qualifies → `malka2026-docker-reproducibility`; cito:extends → `maria2026-executability-denominators`; cito:disagreesWith → `trisovic2022-code-execution`
