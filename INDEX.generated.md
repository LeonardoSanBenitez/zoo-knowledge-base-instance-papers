...
43 deep-read record(s). Regenerate: `python tools/kb.py index`.
...
- **`menkveld2024-nonstandard-errors`** (2024, The Journal of Finance 79(3), 2339-2390) — Nonstandard Errors
  ...
  - cito:agreesWith → `maria2026-analytic-variability-reanalysis`; cito:qualifies → `breznau2022-hidden-universe`; cito:obtainsBackgroundFrom → `breznau2022-hidden-universe`; cito:usesMethodIn → `maria2026-happiness-income-spread`; cito:qualifies → `maria2026-mbp-variability-ratio`
