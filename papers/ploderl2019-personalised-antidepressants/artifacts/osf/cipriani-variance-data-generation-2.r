...
# # # New in Version 2: Detected that Learned2012a Study1 included a typo ("Placebo" instead of "placebo") - corrected with: x$Drug[1172]="placebo"
...
x$Drug[1172]="placebo" # correct typo (see above)
